...
public final class ThreeDeadWheelLocalizer implements Localizer {
    public static class Params {
        public double par0YTicks = -1992.872236399097; // y position of the first parallel encoder (in tick units)
        public double par1YTicks = 1973.7817579961531; // y position of the second parallel encoder (in tick units)
        public double perpXTicks = -2596.9558104864536; // x position of the perpendicular encoder (in tick units)
    }
