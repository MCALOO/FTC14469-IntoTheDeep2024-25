...
public final class ThreeDeadWheelLocalizer implements Localizer {
    public static class Params {
        public double par0YTicks = 1895.5601977160438; // y position of the first parallel encoder (in tick units)
        public double par1YTicks = -2271.3789617992097; // y position of the second parallel encoder (in tick units)
        public double perpXTicks = -2097.148845274877; // x position of the perpendicular encoder (in tick units)
    }
