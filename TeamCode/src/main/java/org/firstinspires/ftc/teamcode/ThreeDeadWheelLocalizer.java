...
public final class ThreeDeadWheelLocalizer implements Localizer {
    public static class Params {
        public double par0YTicks = 1846.5008252952432; // y position of the first parallel encoder (in tick units)
        public double par1YTicks = -2341.247854230556; // y position of the second parallel encoder (in tick units)
        public double perpXTicks = -2095.6964259510637; // x position of the perpendicular encoder (in tick units)
    }
